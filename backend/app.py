...
def add_miner():
    ...
    with miners_lock:
        if miner_id in registered_miners:
            return error(f"Miner '{miner_id}' already exists", 400)
    ...
    return success({"message": "Miner added", "miner_id": miner_id})
...
def stats():
    ...
    return success({
        ...
        "avgBlockTime": blockchain.avg_block_time(),
